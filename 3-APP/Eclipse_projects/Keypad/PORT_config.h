...
#define 	PORTD_PIN0_InitVal	1
#define 	PORTD_PIN1_InitVal	1
#define 	PORTD_PIN2_InitVal	1
#define 	PORTD_PIN3_InitVal	1
#define 	PORTD_PIN4_InitVal	1
#define 	PORTD_PIN5_InitVal	1
#define 	PORTD_PIN6_InitVal	1
#define 	PORTD_PIN7_InitVal	1
